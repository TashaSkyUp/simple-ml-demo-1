...
export const CollapsibleSection: React.FC<CollapsibleSectionProps> = ({
  ...
  return (
    ...
    >
      <button
        onClick={toggleOpen}
        className={`section-header w-full px-6 py-4 text-left flex items-center justify-between hover:bg-gray-700 active:bg-gray-600 transition-all duration-200 focus-visible focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-inset transform hover:scale-[1.01] ${headerClassName}`}
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-xl font-semibold text-gray-100 transition-colors duration-200 hover:text-cyan-300">
            {title}
          </h2>
          {badge && (
